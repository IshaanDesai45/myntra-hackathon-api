...
class GMM(nn.Module):
    ...
    def __init__(self, fine_height=256, fine_width=192, grid_size=5, use_cuda=True):
        ...
        self.regression = FeatureRegression(
            input_nc=192, output_dim=2*grid_size**2, use_cuda=use_cuda)
        self.gridGen = TpsGridGen(
            fine_height, fine_width, use_cuda=use_cuda, grid_size=grid_size)
